...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const termsContent = `
    ...
    <p>لا يجوز استخدام الموقع في أي أنشطة غير قانونية...</p>
    <h3>الملكية الفكرية</h3>
    <p style="color: red;">جميع المحتويات الموجودة في هذا الموقع محمية بموجب قوانين حقوق النشر.</p>
    <h3>تعديلات</h3>
    <p>يحق لنا تعديل شروط الاستخدام في أي وقت دون إشعار مسبق.</p>
    <h3>اتصل بنا</h3>
